...
import com.alvin.dao.impl.MenuImpl;
...
/**
 @Title 		:SelectMenu.java
 @Company 		:永硕
 @Package 		:com.alvin.service
 @Description 	:通过条件查询菜单表
 @author 		:fxd
...
public class SelectMenu {
	...
	public SelectMenu(JSONObject jsonObj){
	  ...
	  * @date	:2019-12-02 22:56
	 */
	 public JSONObject getResult(Menu menu,Map<String, Object> map) throws DaoException{
		List<Menu> list=menuDao.selectByMapMenu(menu,map);
		jsonObj.put("result",list);

		//只有第一页的时候才需要重新的统计，否则不需要再次的统计数量
		if (map.get("pageIndex")!=null&&map.get("pageIndex").equals(1)) {
			int totalCount=menuDao.countByMapMenu(menu,map);
